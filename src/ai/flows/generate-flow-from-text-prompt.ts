...
Ensure the JSON structure is valid and adheres to WhatsApp Flow specifications. Focus on creating a functional and well-structured flow based on the user's prompt.`,
});
