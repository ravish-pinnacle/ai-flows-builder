...
2.  **SCREENS**: Each screen object MUST have an \`id\`, a \`title\`, and a \`layout\` object. Screen \`id\`s MUST be strings containing only uppercase letters, numbers, and underscores (e.g., SCREEN_NAME, STEP_2). The last screen should be marked with \`"terminal": true\`.
