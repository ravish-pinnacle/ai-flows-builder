...
2.  **SCREENS**: Each screen object MUST have an \`id\`, a \`title\`, and a \`layout\` object. Screen \`id\`s MUST be strings containing only uppercase letters and underscores (e.g., SCREEN_NAME, WELCOME_STEP). Numbers are not allowed.
